  ...
  return (
    <div className="h-7 border-b border-[#e0e0e6] bg-[#f0f0f4] flex items-stretch text-[11px] font-mono select-none">
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center space-x-1.5 px-3 bg-white hover:bg-[#111111] hover:text-white border-r border-[#e0e0e6] text-[#111111] transition-colors group"
        title="表示中の時間範囲を再生"
      >
        <Play className="w-2.5 h-2.5 opacity-60 group-hover:opacity-100 fill-current" />
        <span className="font-bold text-[10px] text-[#777780] group-hover:text-white/70 uppercase">
          Window:
        </span>
      ...
      <button
        ...
        className={`flex-1 flex items-center justify-center space-x-1.5 px-3 border-r border-[#e0e0e6] transition-colors group ${
          hasSelection
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center space-x-1.5 px-3 bg-white hover:bg-[#111111] hover:text-white text-[#111111] transition-colors group"
        title="音声全体を再生"
      >
        <Play className="w-2.5 h-2.5 opacity-60 group-hover:opacity-100 fill-current" />
        <span className="font-bold text-[10px] text-[#777780] group-hover:text-white/70 uppercase">
